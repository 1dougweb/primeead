...
class ChatSettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        SystemSetting::set('landing_chat_welcome_message', 'Olá! Me chamo Anne da Educa Prime. Como posso te ajudar hoje? Posso orientar sobre matrículas, pagamentos, disciplinas e muito mais! 💡 Digite seu email para atendimento personalizado!', 'string', 'landing_page', 'Mensagem de boas-vindas do chat');
        ...
        SystemSetting::set('mail_from_address', 'contato@primeead.com.br', 'string', 'landing_page', 'Email de contato para suporte');
