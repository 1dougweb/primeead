...
class PaymentNotificationServiceMockedTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Mock SystemSetting
        $this->mock(SystemSetting::class, function ($mock) {
            $mock->shouldReceive('getPaymentSettings')
                ->andReturn([
                    'mercadopago_enabled' => true,
                    'mercadopago_email_notifications' => true,
                    'mercadopago_whatsapp_notifications' => true,
