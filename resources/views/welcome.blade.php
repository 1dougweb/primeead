...
<html lang="pt-br">
    ...
    @if($landingSettings['gtm_enabled'] ?? false)
        @if(!empty($landingSettings['gtm_id']))
            <!-- Google Tag Manager -->
            <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
            new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
            j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
            'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
            })(window,document,'script','dataLayer','{{ $landingSettings['gtm_id'] }}');</script>
...
<body>
    ...
    <div id="cookie-consent">
        <div class="cookie-content">
            <div class="cookie-text">
                ...
                <p>Este site utiliza cookies e tecnologias semelhantes para personalizar conteúdo, analisar o tráfego e melhorar sua experiência de navegação, conforme nossa <a href="{{ route('politica-privacidade') }}">Política de Privacidade</a>.</p>
        ...
        <div class="hero-content container">
            ...
            <div class="hero-offer">
                ...
                <div class="form-container">
                    ...
                    <form method="POST" action="{{ route('inscricao.store') }}" id="formulario-contato">
                        @csrf
                        <input type="hidden" name="curso" value="{{ $defaultCourse }}">
                        ...
                        <div class="form-group custom-select">
                            <select name="modalidade" required>
                                <option value="" disabled {{ old('modalidade') ? '' : 'selected' }}>Escolha a modalidade</option>
                                @foreach($availableModalities as $value => $label)
                                    <option value="{{ $value }}" {{ old('modalidade', $defaultModality) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                ...
                <div class="benefits-column">
                    <div class="benefit-item">
                        <div class="benefit-icon">
                            <img src="{{ asset('assets/images/674325745_.png') }}" alt="Ícone Professor">
                        </div>
                    ...
                    <div class="benefit-item">
                        <div class="benefit-icon">
                            <img src="{{ asset('assets/images/674325743_.png') }}" alt="Ícone Relógio">
                        </div>
                        <div class="benefit-content">
                    ...
                    <div class="benefit-item">
                        <div class="benefit-icon">
                            <img src="{{ asset('assets/images/674325744_.png') }}" alt="Ícone Certificado">
                        </div>
                        <div class="benefit-content">
            ...
            <div class="estude-casa-content">
                ...
                <div class="estude-casa-images">
                    <div class="image-container image-1">
                        <img src="{{ asset('assets/images/depositphotos_196018166-stock-photo-serious-student-writing-homework-table.webp') }}" alt="Estudante estudando em casa" class="placeholder-img">
                    </div>
                    <div class="image-container image-2">
                        <img src="{{ asset('assets/images/istockphoto-1443305526-612x612-1.jpg') }}" alt="Estudante no computador" class="placeholder-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="duvidas-content">
                <div class="duvidas-form">
                    ...
                    <form id="formulario-duvidas" method="POST" action="{{ route('inscricao.store') }}">
                        @csrf
                        <input type="hidden" name="curso" value="{{ $defaultCourse }}">
                        ...
                        <div class="form-group custom-select">
                            <select name="modalidade" required>
                                ...
                                @foreach($availableModalities as $value => $label)
                                    <option value="{{ $value }}" {{ $defaultModality == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            <div class="select-arrow"></div>
                        </div>
            ...
            <div class="oferta-content">
                <div class="oferta-text">
                    ...
                    <div class="promocao-banner">                        
                        <div class="countdown-container">
                            <div class="promocao-header-container">
                                <span><strong>{{ $countdownSettings['text'] }} {{ $countdownSettings['end_date_formatted'] }}</strong></span>
                                <div class="promocao-desconto">{{ $countdownSettings['discount_text'] }}</div>
                            </div>
                    ...
                    <div class="precos-container">
                        <div class="preco-desconto">
                            ...
                            <div class="preco-sublabel">até {{ $countdownSettings['price_installments_discount'] }} de</div>
                            <div class="preco-valor">{{ $countdownSettings['price_discount'] }}</div>
                        </div>
                        
                        <div class="preco-original">
                            <div class="preco-label">Preço original</div>
                            <div class="preco-sublabel">até {{ $countdownSettings['price_installments_original'] }} de</div>
                            <div class="preco-valor">{{ $countdownSettings['price_original'] }}</div>
                        </div>
                    </div>
                    ...
                    <div class="valor-total-info">
                        <div class="valor-pix-container">
                            ...
                            <div class="pix-valor">{{ $countdownSettings['pix_price'] }}</div>
                        </div>
                ...
                <div class="oferta-form">
                    <div class="form-container-oferta">
                        ...
                        <form method="POST" action="{{ route('inscricao.store') }}" id="formulario-oferta">
                            @csrf
                            <input type="hidden" name="curso" value="{{ $defaultCourse }}">
                            
                            <div class="form-group">
                                <input type="text" name="nome" placeholder="Name" value="{{ old('nome') }}" required>
                            </div>
                            ...
                            <div class="form-group phone-input-container">
                                <input type="tel" id="phone-oferta" name="telefone" placeholder="(11) 99999-9999" value="{{ old('telefone') }}" required>
                            </div>
                            ...
                            <div class="form-group checkbox">
                                <input type="checkbox" id="termos-oferta" name="termos" {{ old('termos') ? 'checked' : '' }} required>
    ...
    <script>
        ...
        function initCountdown() {
            ...
            const endDate = {{ $countdownSettings['end_timestamp'] }};
    ...
    @if($landingSettings['gtm_enabled'] ?? false)
        @if(!empty($landingSettings['gtm_id']))
            <!-- Google Tag Manager (noscript) -->
            <noscript><iframe src="https://www.googletagmanager.com/ns.html?id={{ $landingSettings['gtm_id'] }}"
            height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
            <!-- End Google Tag Manager (noscript) -->
        @endif
    @endif
