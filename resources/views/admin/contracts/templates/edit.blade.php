...
@section('title', 'Editar Template de Contrato')
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.contracts.templates.update', $template) }}" method="POST">
                        @csrf
                        @method('PUT')
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('validity_days') is-invalid @enderror" 
                                                           id="validity_days" name="validity_days" value="{{ old('validity_days', $template->validity_days) }}" 
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                                      id="content" name="content" rows="20" required>{{ old('content', $template->content) }}</textarea>
                                            @error('content')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div class="form-text">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <span class="badge bg-info">{{ $template->contracts_count }}</span>
                                        </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="variablesList" style="max-height: 300px; overflow-y: auto;">
...
function showPreview() {
    ...
    const fullHtml = `
        ...
        <head>
            ...
            <title>Preview do Template - ${document.getElementById('name').value || 'Template'}</title>
