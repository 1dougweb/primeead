...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.inscricoes.importar') }}" class="btn btn-primary">
                <i class="fas fa-upload me-2"></i>Importar CSV
            </a>
            <a href="{{ route('admin.inscricoes.exportar', request()->query()) }}" class="btn btn-success">
                <i class="fas fa-download me-2"></i>Exportar CSV
            </a>
            @can('inscricoes.delete')
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-0">
                    <form method="GET" action="{{ route('admin.inscricoes') }}" class="row g-0" id="filterForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 d-flex align-items-end">
                                    <div class="d-flex gap-2 w-100">
                                        <a href="{{ route('admin.inscricoes') }}" class="btn btn-light flex-grow-1" id="clearFilters">
    ...
    <div class="card border-0 shadow-sm">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <span class="text-muted">
                        Total: {{ $inscricoes->total() }} inscrições
                    </span>
        ...
        <div class="card-body p-0" id="listaInscricoes">
            @include('admin.inscricoes._lista')
        </div>
    </div>
