...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.parceiros.store') }}" method="POST">
        @csrf
            ...
            <div class="col-lg-8">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('modalidade_parceria') is-invalid @enderror" 
                                    ...
                                    <option value="">Selecione</option>
                                    <option value="Polo Presencial" {{ old('modalidade_parceria') === 'Polo Presencial' ? 'selected' : '' }}>Polo Presencial</option>
                                    <option value="EaD" {{ old('modalidade_parceria') === 'EaD' ? 'selected' : '' }}>EaD</option>
                                    <option value="Híbrido" {{ old('modalidade_parceria') === 'Híbrido' ? 'selected' : '' }}>Híbrido</option>
                                    <option value="Representante" {{ old('modalidade_parceria') === 'Representante' ? 'selected' : '' }}>Representante</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('disponibilidade') is-invalid @enderror" 
                                    ...
                                    <option value="">Selecione</option>
                                    <option value="meio_periodo" {{ old('disponibilidade') === 'meio_periodo' ? 'selected' : '' }}>Meio Período</option>
                                    <option value="integral" {{ old('disponibilidade') === 'integral' ? 'selected' : '' }}>Integral</option>
                                    <option value="fins_semana" {{ old('disponibilidade') === 'fins_semana' ? 'selected' : '' }}>Fins de Semana</option>
                                    <option value="flexivel" {{ old('disponibilidade') === 'flexivel' ? 'selected' : '' }}>Flexível</option>
                                </select>
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('possui_estrutura') is-invalid @enderror" 
                                               ...
                                               {{ old('possui_estrutura') === '1' ? 'checked' : '' }} required>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('possui_estrutura') is-invalid @enderror" 
                                               ...
                                               {{ old('possui_estrutura') === '0' ? 'checked' : '' }} required>
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('tem_experiencia_educacional') is-invalid @enderror" 
                                               ...
                                               {{ old('tem_experiencia_educacional') === '1' ? 'checked' : '' }} required>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('tem_experiencia_educacional') is-invalid @enderror" 
                                               ...
                                               {{ old('tem_experiencia_educacional') === '0' ? 'checked' : '' }} required>
                        ...
                        <div class="row" id="site_url_field" style="{{ old('tem_site') === '1' ? '' : 'display: none;' }}">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="url" class="form-control @error('site_url') is-invalid @enderror" 
                                       id="site_url" name="site_url" value="{{ old('site_url') }}">
                                @error('site_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('plano_negocio') is-invalid @enderror" 
                                          id="plano_negocio" name="plano_negocio" rows="4">{{ old('plano_negocio') }}</textarea>
                                @error('plano_negocio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('experiencia_vendas') is-invalid @enderror" 
                                          id="experiencia_vendas" name="experiencia_vendas" rows="3">{{ old('experiencia_vendas') }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('motivacao') is-invalid @enderror" 
                                          id="motivacao" name="motivacao" rows="3">{{ old('motivacao') }}</textarea>
                                @error('motivacao')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('comissao_percentual') is-invalid @enderror" 
                                   ...
                                   value="{{ old('comissao_percentual', '10') }}" 
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Criar Parceiro
                            </button>
                            <a href="{{ route('admin.parceiros.index') }}" class="btn btn-secondary">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            ...
                            <strong>Dica:</strong> Preencha todos os campos obrigatórios (*) para criar o parceiro. 
