    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0">✏️ Editar Role</h1>
                    <p class="text-muted mb-0">Modificar role: {{ $role->name }}</p>
                </div>
                <div>
                    ...
                    <form action="{{ route('admin.permissions.roles.update', $role) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <h5 class="mb-3">
                                ...
                                <small class="text-muted">(<span id="selectedCount">{{ count($rolePermissions) }}</span> selecionadas)</small>
                            </h5>
