...
@if($chatEnabled)
<div id="chat-widget" class="chat-widget chat-widget-{{ $chatPosition }}" style="--chat-color: {{ $chatColor }};">
    <!-- Botão do Chat -->
...
function showWelcomeMessageWithDelay() {
    ...
    let welcomeMessage = '{{ $chatWelcomeMessage }}';
...
function createWhatsAppButton() {
    const phoneNumber = '{{ $landingSettings["support_phone"] ?? "5511917012033" }}';
