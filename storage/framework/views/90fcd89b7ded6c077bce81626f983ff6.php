...
<?php if($trackingSettings['enable_google_analytics'] && !empty($trackingSettings['google_tag_manager_id'])): ?>
    ...
    })(window,document,'script','dataLayer','<?php echo e($trackingSettings['google_tag_manager_id']); ?>');
    </script>
...
<?php if($trackingSettings['enable_facebook_pixel'] && !empty($trackingSettings['facebook_pixel_id'])): ?>
    <!-- Facebook Pixel Code -->
    <script>
    try {
        ...
        fbq('init', '<?php echo e($trackingSettings['facebook_pixel_id']); ?>', {
            external_id: '<?php echo e($visitorId); ?>'
        });
        
        // Evento de visualização de página
        fbq('track', 'PageView', {
            page_title: '<?php echo e($pageTitle); ?>',
            page_type: '<?php echo e($pageType); ?>'
        });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            forms.forEach(function(form) {
                form.addEventListener('submit', function() {
                    ...
                    fbq('track', 'Lead', {
                        form_id: formId,
                        content_name: '<?php echo e($pageTitle); ?>'
                    });
                });
            });
        });
    ...
    <noscript>
        <img height="1" width="1" style="display:none" 
             src="https://www.facebook.com/tr?id=<?php echo e($trackingSettings['facebook_pixel_id']); ?>&ev=PageView&noscript=1"/>
    </noscript>
...
<?php endif; ?> <?php /**PATH /home/douglas/Downloads/ec-complete-backup-20250728_105142/ec-complete-backup-20250813_144041/resources/views/components/tracking-scripts.blade.php ENDPATH**/ ?>