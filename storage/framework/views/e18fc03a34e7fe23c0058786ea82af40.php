...
<?php $__env->startSection('page-title', 'Configurações do Sistema'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.executeMigration = function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Enviar requisição
                fetch('<?php echo e(route("admin.settings.execute-migration")); ?>', {
                    method: 'POST',
                    headers: {
    ...
    document.getElementById('testAiConnection')?.addEventListener('click', function() {
        ...
        // Enviar requisição
        fetch('<?php echo e(route("admin.settings.ai.test")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
    ...
    document.getElementById('testMercadoPagoConnection')?.addEventListener('click', function() {
        ...
        // Enviar requisição
        fetch('<?php echo e(route("admin.payments.test-connection")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
<div class="container-fluid">
    ...
    <form id="settingsForm" method="POST" action="<?php echo e(route('admin.settings.update')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="card-body text-center">
                                            <div class="mb-3">
                                                <img id="sidebar-logo-preview" 
                                                     src="<?php echo e($appearanceSettings['sidebar_logo_path'] ?? '/assets/images/logotipo-dark.svg'); ?>" 
                                                     alt="Logo Sidebar" 
                                                     class="img-fluid" 
                                        ...
                                        <div class="card-body text-center">
                                            <div class="mb-3">
                                                <img id="login-logo-preview" 
                                                     src="<?php echo e($appearanceSettings['login_logo_path'] ?? '/assets/images/logotipo-dark.svg'); ?>" 
                                                     alt="Logo Login" 
                                                     class="img-fluid" 
                                                     style="max-height: 80px; max-width: 200px;">
                                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" id="lead_cooldown_minutes" name="lead_cooldown_minutes" 
                                       value="<?php echo e(old('lead_cooldown_minutes', $leadSettings['cooldown_minutes'] ?? 2)); ?>" min="0">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" id="auto_unlock_hours" name="auto_unlock_hours" 
                                       value="<?php echo e(old('auto_unlock_hours', $leadSettings['auto_unlock_hours'] ?? 24)); ?>" min="0">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" id="max_leads_per_user" name="max_leads_per_user" 
                                       value="<?php echo e(old('max_leads_per_user', $leadSettings['max_leads_per_user'] ?? 10)); ?>" min="1">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = File::files(database_path('migrations')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($file->getFilename()); ?></td>
                                            <td>
                                                <button type="button" class="btn btn-sm btn-primary" 
                                                        onclick="selectMigration('<?php echo e($file->getFilename()); ?>')">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="enable_google_analytics" name="enable_google_analytics" value="1"
                                           <?php echo e(old('enable_google_analytics', $settings['enable_google_analytics'] ?? false) ? 'checked' : ''); ?>>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="enable_facebook_pixel" name="enable_facebook_pixel" value="1"
                                           <?php echo e(old('enable_facebook_pixel', $settings['enable_facebook_pixel'] ?? false) ? 'checked' : ''); ?>>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="landing_gtm_enabled" name="landing_gtm_enabled" value="1"
                                           <?php echo e(old('landing_gtm_enabled', $landingSettings['gtm_enabled'] ?? false) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="landing_gtm_id" name="landing_gtm_id" 
                                                   value="<?php echo e(old('landing_gtm_id', $landingSettings['gtm_id'] ?? '')); ?>"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="landing_gtm_events" name="landing_gtm_events" rows="4" 
                                                  placeholder="Configurações de eventos personalizados para GTM da landing page"><?php echo e(old('landing_gtm_events', $landingSettings['gtm_events'] ?? '')); ?></textarea>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="enable_email" name="enable_email" value="1"
                                                   <?php echo e(old('enable_email', $settings['enable_email'] ?? false) ? 'checked' : ''); ?>>
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control" id="mail_from_address" name="mail_from_address" 
                                               value="<?php echo e(old('mail_from_address', $settings['mail_from_address'] ?? 'contato@ensinocerto.com.br')); ?>"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="mail_from_name" name="mail_from_name" 
                                               value="<?php echo e(old('mail_from_name', $settings['mail_from_name'] ?? 'EJA Admin')); ?>"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control" id="mail_reply_to" name="mail_reply_to" 
                                               value="<?php echo e(old('mail_reply_to', $settings['mail_reply_to'] ?? '')); ?>"
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control" id="admin_notification_email" name="admin_notification_email" 
                                               value="<?php echo e(old('admin_notification_email', $settings['admin_notification_email'] ?? '')); ?>"
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" id="notify_new_lead" name="notify_new_lead" value="1"
                                               <?php echo e(old('notify_new_lead', $settings['notify_new_lead'] ?? true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" id="notify_status_change" name="notify_status_change" value="1"
                                               <?php echo e(old('notify_status_change', $settings['notify_status_change'] ?? false) ? 'checked' : ''); ?>>
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" id="mail_mailer" name="mail_mailer">
                                            ...
                                            <option value="log" <?php echo e((old('mail_mailer', $settings['mail_mailer'] ?? '') == 'log') ? 'selected' : ''); ?>>Log (para testes)</option>
                                        </select>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="mail_host" name="mail_host" 
                                               value="<?php echo e(old('mail_host', $settings['mail_host'] ?? 'smtp.gmail.com')); ?>"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" id="mail_encryption" name="mail_encryption">
                                                    ...
                                                    <option value="" <?php echo e((old('mail_encryption', $settings['mail_encryption'] ?? '') == '') ? 'selected' : ''); ?>>Nenhuma</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="alert alert-info">
                                ...
                                <a href="<?php echo e(route('admin.email-templates.index')); ?>" class="alert-link">Clique aqui</a> para editar os templates de email.
                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="send_confirmation_email" name="send_confirmation_email" value="1"
                                                       <?php echo e(old('send_confirmation_email', $settings['send_confirmation_email'] ?? true) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="send_admin_notification" name="send_admin_notification" value="1"
                                                       <?php echo e(old('send_admin_notification', $settings['send_admin_notification'] ?? true) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="send_followup_email" name="send_followup_email" value="1"
                                                       <?php echo e(old('send_followup_email', $settings['send_followup_email'] ?? false) ? 'checked' : ''); ?>>
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="thank_you_page_title" name="thank_you_page_title" 
                                       value="<?php echo e(old('thank_you_page_title', $settings['thank_you_page_title'] ?? 'Inscrição Confirmada!')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="color" class="form-control form-control-color" id="thank_you_header_color" name="thank_you_header_color" 
                                       value="<?php echo e(old('thank_you_header_color', $settings['thank_you_header_color'] ?? '#3a5998')); ?>">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="thank_you_page_subtitle" name="thank_you_page_subtitle" 
                               value="<?php echo e(old('thank_you_page_subtitle', $settings['thank_you_page_subtitle'] ?? 'Sua inscrição foi realizada com sucesso. Nossa equipe entrará em contato em breve.')); ?>">
                    </div>
                    
                    <div class="form-group mb-3">
                        <label for="thank_you_custom_message" class="form-label">Mensagem Personalizada</label>
                        <textarea class="form-control" id="thank_you_custom_message" name="thank_you_custom_message" rows="4"><?php echo e(old('thank_you_custom_message', $settings['thank_you_custom_message'] ?? '')); ?></textarea>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="thank_you_contact_phone" name="thank_you_contact_phone" 
                                       value="<?php echo e(old('thank_you_contact_phone', $settings['thank_you_contact_phone'] ?? '(11) 9999-9999')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="email" class="form-control" id="thank_you_contact_email" name="thank_you_contact_email" 
                                       value="<?php echo e(old('thank_you_contact_email', $settings['thank_you_contact_email'] ?? 'contato@ensinocerto.com.br')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="thank_you_contact_hours" name="thank_you_contact_hours" 
                                       value="<?php echo e(old('thank_you_contact_hours', $settings['thank_you_contact_hours'] ?? 'Seg-Sex: 8h às 18h')); ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="thank_you_show_contact_info" name="thank_you_show_contact_info" value="1"
                                       <?php echo e(old('thank_you_show_contact_info', $settings['thank_you_show_contact_info'] ?? true) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="thank_you_show_steps" name="thank_you_show_steps" value="1"
                                       <?php echo e(old('thank_you_show_steps', $settings['thank_you_show_steps'] ?? true) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="thank_you_show_tips" name="thank_you_show_tips" value="1"
                                       <?php echo e(old('thank_you_show_tips', $settings['thank_you_show_tips'] ?? true) ? 'checked' : ''); ?>>
                        ...
                        <div class="card-body">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="whatsapp_enabled" name="whatsapp_enabled" value="1"
                                       <?php echo e(old('whatsapp_enabled', $whatsappSettings['whatsapp_enabled'] ?? true) ? 'checked' : ''); ?>>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="whatsapp_number" name="whatsapp_number" 
                                               value="<?php echo e(old('whatsapp_number', $whatsappSettings['whatsapp_number'] ?? '5511999999999')); ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" id="whatsapp_button_position" name="whatsapp_button_position">
                                            <option value="bottom-right" <?php echo e(old('whatsapp_button_position', $whatsappSettings['whatsapp_button_position'] ?? 'bottom-right') == 'bottom-right' ? 'selected' : ''); ?>>Canto inferior direito</option>
                                            <option value="bottom-left" <?php echo e(old('whatsapp_button_position', $whatsappSettings['whatsapp_button_position'] ?? 'bottom-right') == 'bottom-left' ? 'selected' : ''); ?>>Canto inferior esquerdo</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="color" class="form-control form-control-color" id="whatsapp_button_color" name="whatsapp_button_color" 
                                               value="<?php echo e(old('whatsapp_button_color', $whatsappSettings['whatsapp_button_color'] ?? '#25d366')); ?>">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" id="whatsapp_message" name="whatsapp_message" rows="3"><?php echo e(old('whatsapp_message', $whatsappSettings['whatsapp_message'] ?? 'Olá! Tenho interesse no curso EJA. Podem me ajudar?')); ?></textarea>
                ...
                <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="countdown_enabled" name="countdown_enabled" value="1"
                                       <?php echo e(old('countdown_enabled', $countdownSettings['enabled'] ?? true) ? 'checked' : ''); ?>>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control" id="countdown_end_date" name="countdown_end_date" 
                                               value="<?php echo e(old('countdown_end_date', $countdownSettings['end_date'] ?? '2025-12-31')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="time" class="form-control" id="countdown_end_time" name="countdown_end_time" 
                                               value="<?php echo e(old('countdown_end_time', $countdownSettings['end_time'] ?? '23:59')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" id="countdown_timezone" name="countdown_timezone">
                                            <option value="America/Sao_Paulo" <?php echo e(old('countdown_timezone', $countdownSettings['timezone'] ?? 'America/Sao_Paulo') == 'America/Sao_Paulo' ? 'selected' : ''); ?>>Brasília (GMT-3)</option>
                                            <option value="America/New_York" <?php echo e(old('countdown_timezone', $countdownSettings['timezone'] ?? 'America/Sao_Paulo') == 'America/New_York' ? 'selected' : ''); ?>>Nova York (GMT-5)</option>
                                            <option value="Europe/London" <?php echo e(old('countdown_timezone', $countdownSettings['timezone'] ?? 'America/Sao_Paulo') == 'Europe/London' ? 'selected' : ''); ?>>Londres (GMT)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="alert alert-warning">
                                <i class="fas fa-exclamation-triangle me-2"></i>
                                <strong>Data Atual da Oferta:</strong> <?php echo e($countdownSettings['end_date_formatted'] ?? '31 de Dezembro'); ?> às <?php echo e($countdownSettings['end_time'] ?? '23:59'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="countdown_text" name="countdown_text" 
                                               value="<?php echo e(old('countdown_text', $countdownSettings['text'] ?? 'Somente até')); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="countdown_discount_text" name="countdown_discount_text" 
                                               value="<?php echo e(old('countdown_discount_text', $countdownSettings['discount_text'] ?? '50% OFF')); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="countdown_price_discount" name="countdown_price_discount" 
                                               value="<?php echo e(old('countdown_price_discount', $countdownSettings['price_discount'] ?? 'R$ 89,90')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="countdown_price_installments_discount" name="countdown_price_installments_discount" 
                                               value="<?php echo e(old('countdown_price_installments_discount', $countdownSettings['price_installments_discount'] ?? '12x')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="countdown_price_original" name="countdown_price_original" 
                                               value="<?php echo e(old('countdown_price_original', $countdownSettings['price_original'] ?? 'R$ 284,90')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="countdown_price_installments_original" name="countdown_price_installments_original" 
                                               value="<?php echo e(old('countdown_price_installments_original', $countdownSettings['price_installments_original'] ?? '24x')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="countdown_pix_price" name="countdown_pix_price" 
                                               value="<?php echo e(old('countdown_pix_price', $countdownSettings['pix_price'] ?? 'R$ 899,00')); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" id="countdown_renewal_type" name="countdown_renewal_type">
                                            <option value="manual" <?php echo e(old('countdown_renewal_type', $countdownSettings['renewal_type'] ?? 'monthly') == 'manual' ? 'selected' : ''); ?>>Manual</option>
                                            <option value="daily" <?php echo e(old('countdown_renewal_type', $countdownSettings['renewal_type'] ?? 'monthly') == 'daily' ? 'selected' : ''); ?>>Diária</option>
                                            <option value="weekly" <?php echo e(old('countdown_renewal_type', $countdownSettings['renewal_type'] ?? 'monthly') == 'weekly' ? 'selected' : ''); ?>>Semanal</option>
                                            <option value="monthly" <?php echo e(old('countdown_renewal_type', $countdownSettings['renewal_type'] ?? 'monthly') == 'monthly' ? 'selected' : ''); ?>>Mensal</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control" id="countdown_auto_extend_days" name="countdown_auto_extend_days" 
                                               value="<?php echo e(old('countdown_auto_extend_days', $countdownSettings['auto_extend_days'] ?? 30)); ?>" min="1">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_hero_title" name="landing_hero_title" 
                                               value="<?php echo e(old('landing_hero_title', $landingSettings['hero_title'] ?? 'Transforme sua vida com Ensino Superior de Qualidade!')); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="landing_hero_subtitle" name="landing_hero_subtitle" rows="2"><?php echo e(old('landing_hero_subtitle', $landingSettings['hero_subtitle'] ?? 'Diplomas reconhecidos pelo MEC, aulas 100% online e suporte dedicado para sua jornada acadêmica.')); ?></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_cta_button_text" name="landing_cta_button_text" 
                                               value="<?php echo e(old('landing_cta_button_text', $landingSettings['cta_button_text'] ?? 'QUERO MINHA VAGA!')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="color" class="form-control form-control-color" id="landing_cta_button_color" name="landing_cta_button_color" 
                                               value="<?php echo e(old('landing_cta_button_color', $landingSettings['cta_button_color'] ?? '#28a745')); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_benefits_title" name="landing_benefits_title" 
                                               value="<?php echo e(old('landing_benefits_title', $landingSettings['benefits_title'] ?? 'Por que escolher a Ensino Certo?')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_benefit_1" name="landing_benefit_1" 
                                               value="<?php echo e(old('landing_benefit_1', $landingSettings['benefit_1'] ?? '✅ Diplomas Reconhecidos pelo MEC')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_benefit_2" name="landing_benefit_2" 
                                               value="<?php echo e(old('landing_benefit_2', $landingSettings['benefit_2'] ?? '✅ Aulas 100% Online')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_benefit_3" name="landing_benefit_3" 
                                               value="<?php echo e(old('landing_benefit_3', $landingSettings['benefit_3'] ?? '✅ Preços Acessíveis')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_benefit_4" name="landing_benefit_4" 
                                               value="<?php echo e(old('landing_benefit_4', $landingSettings['benefit_4'] ?? '✅ Suporte Especializado')); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_form_title" name="landing_form_title" 
                                               value="<?php echo e(old('landing_form_title', $landingSettings['form_title'] ?? 'Preencha seus dados e garanta sua vaga!')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_form_subtitle" name="landing_form_subtitle" 
                                               value="<?php echo e(old('landing_form_subtitle', $landingSettings['form_subtitle'] ?? 'É rápido, fácil e gratuito!')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_form_button_text" name="landing_form_button_text" 
                                               value="<?php echo e(old('landing_form_button_text', $landingSettings['form_button_text'] ?? 'GARANTIR MINHA VAGA')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="color" class="form-control form-control-color" id="landing_form_button_color" name="landing_form_button_color" 
                                               value="<?php echo e(old('landing_form_button_color', $landingSettings['form_button_color'] ?? '#dc3545')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" id="default_course" name="default_course">
                                            <?php $__currentLoopData = $formSettings['available_courses'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php echo e(($formSettings['default_course'] ?? '') == $key ? 'selected' : ''); ?>>
                                                    <?php echo e($label); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" id="default_modality" name="default_modality">
                                            <?php $__currentLoopData = $formSettings['available_modalities'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php echo e(($formSettings['default_modality'] ?? '') == $key ? 'selected' : ''); ?>>
                                                    <?php echo e($label); ?>
                                            ...
                                            <div id="coursesEditor" class="json-editor">
                                                <table class="table table-sm">
                                                    ...
                                                    <tbody id="coursesTableBody">
                                                        <?php $__currentLoopData = $formSettings['available_courses'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="form-control form-control-sm" 
                                                                           name="available_courses_keys[]" value="<?php echo e($key); ?>" required>
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control form-control-sm" 
                                                                           name="available_courses_values[]" value="<?php echo e($value); ?>" required>
                                                                </td>
                                                                <td>
                                                                    <button type="button" class="btn btn-sm btn-danger remove-row">
                                                                        <i class="fas fa-times"></i>
                                            ...
                                            <div id="modalitiesEditor" class="json-editor">
                                                <table class="table table-sm">
                                                    ...
                                                    <tbody id="modalitiesTableBody">
                                                        <?php $__currentLoopData = $formSettings['available_modalities'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="form-control form-control-sm" 
                                                                           name="available_modalities_keys[]" value="<?php echo e($key); ?>" required>
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control form-control-sm" 
                                                                           name="available_modalities_values[]" value="<?php echo e($value); ?>" required>
                                                                </td>
                                                                <td>
                                                                    <button type="button" class="btn btn-sm btn-danger remove-row">
                                                                        <i class="fas fa-times"></i>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_footer_company_name" name="landing_footer_company_name" 
                                               value="<?php echo e(old('landing_footer_company_name', $landingSettings['footer_company_name'] ?? 'Ensino Certo')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control" id="landing_footer_email" name="landing_footer_email" 
                                               value="<?php echo e(old('landing_footer_email', $landingSettings['footer_email'] ?? 'contato@ensinocerto.com.br')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_footer_phone" name="landing_footer_phone" 
                                               value="<?php echo e(old('landing_footer_phone', $landingSettings['footer_phone'] ?? '(11) 99999-9999')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_footer_address" name="landing_footer_address" 
                                               value="<?php echo e(old('landing_footer_address', $landingSettings['footer_address'] ?? 'São Paulo, SP - Brasil')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_footer_copyright" name="landing_footer_copyright" 
                                               value="<?php echo e(old('landing_footer_copyright', $landingSettings['footer_copyright'] ?? '© 2025 Ensino Certo. Todos os direitos reservados.')); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-text">
                                            ...
                                            <?php if(isset($landingSettings['mec_authorization_file']) && $landingSettings['mec_authorization_file']): ?>
                                                <br><strong>Arquivo atual:</strong> 
                                                <a href="<?php echo e(asset('storage/' . $landingSettings['mec_authorization_file'])); ?>" target="_blank" class="text-primary">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="landing_mec_address" name="landing_mec_address" rows="3" placeholder="Digite o endereço que aparecerá abaixo da autorização do MEC"><?php echo e(old('landing_mec_address', $landingSettings['mec_address'] ?? '')); ?></textarea>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-text">
                                            <?php if(isset($landingSettings['footer_image_1']) && $landingSettings['footer_image_1']): ?>
                                                <strong>Imagem atual:</strong><br>
                                                <img src="<?php echo e(asset('storage/' . $landingSettings['footer_image_1'])); ?>" alt="Imagem 1" class="img-thumbnail mt-2" style="max-width: 150px; max-height: 100px;">
                                            <?php else: ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-text">
                                            <?php if(isset($landingSettings['footer_image_2']) && $landingSettings['footer_image_2']): ?>
                                                <strong>Imagem atual:</strong><br>
                                                <img src="<?php echo e(asset('storage/' . $landingSettings['footer_image_2'])); ?>" alt="Imagem 2" class="img-thumbnail mt-2" style="max-width: 150px; max-height: 100px;">
                                            <?php else: ?>
                                                <em>Nenhuma imagem foi enviada ainda.</em>
                                            <?php endif; ?>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-text">
                                            <?php if(isset($landingSettings['footer_image_3']) && $landingSettings['footer_image_3']): ?>
                                                <strong>Imagem atual:</strong><br>
                                                <img src="<?php echo e(asset('storage/' . $landingSettings['footer_image_3'])); ?>" alt="Imagem 3" class="img-thumbnail mt-2" style="max-width: 150px; max-height: 100px;">
                                            <?php else: ?>
                                                <em>Nenhuma imagem foi enviada ainda.</em>
                                            <?php endif; ?>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="landing_social_facebook" name="landing_social_facebook" 
                                               value="<?php echo e(old('landing_social_facebook', $landingSettings['social_facebook'] ?? '')); ?>" placeholder="https://facebook.com/suapagina">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="landing_social_instagram" name="landing_social_instagram" 
                                               value="<?php echo e(old('landing_social_instagram', $landingSettings['social_instagram'] ?? '')); ?>" placeholder="https://instagram.com/suapagina">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="landing_social_linkedin" name="landing_social_linkedin" 
                                               value="<?php echo e(old('landing_social_linkedin', $landingSettings['social_linkedin'] ?? '')); ?>" placeholder="https://linkedin.com/company/suaempresa">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="landing_social_youtube" name="landing_social_youtube" 
                                               value="<?php echo e(old('landing_social_youtube', $landingSettings['social_youtube'] ?? '')); ?>" placeholder="https://youtube.com/c/seucanal">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="landing_social_tiktok" name="landing_social_tiktok" 
                                               value="<?php echo e(old('landing_social_tiktok', $landingSettings['social_tiktok'] ?? '')); ?>" placeholder="https://tiktok.com/@seuusuario">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="color" class="form-control form-control-color" id="landing_primary_color" name="landing_primary_color" 
                                               value="<?php echo e(old('landing_primary_color', $landingSettings['primary_color'] ?? '#007bff')); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="color" class="form-control form-control-color" id="landing_secondary_color" name="landing_secondary_color" 
                                               value="<?php echo e(old('landing_secondary_color', $landingSettings['secondary_color'] ?? '#6c757d')); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="color" class="form-control form-control-color" id="landing_accent_color" name="landing_accent_color" 
                                               value="<?php echo e(old('landing_accent_color', $landingSettings['accent_color'] ?? '#28a745')); ?>">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="landing_chat_enabled" name="landing_chat_enabled" 
                                                   value="1" <?php echo e(old('landing_chat_enabled', $landingSettings['chat_enabled'] ?? false) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="landing_chat_title" name="landing_chat_title" 
                                               value="<?php echo e(old('landing_chat_title', $landingSettings['chat_title'] ?? 'Precisa de ajuda?')); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" id="landing_chat_position" name="landing_chat_position">
                                            <option value="bottom-right" <?php echo e(($landingSettings['chat_position'] ?? 'bottom-right') == 'bottom-right' ? 'selected' : ''); ?>>Canto inferior direito</option>
                                            <option value="bottom-left" <?php echo e(($landingSettings['chat_position'] ?? 'bottom-right') == 'bottom-left' ? 'selected' : ''); ?>>Canto inferior esquerdo</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="color" class="form-control form-control-color" id="landing_chat_color" name="landing_chat_color" 
                                               value="<?php echo e(old('landing_chat_color', $landingSettings['chat_color'] ?? '#007bff')); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" id="landing_chat_icon" name="landing_chat_icon">
                                            <option value="fas fa-comments" <?php echo e(($landingSettings['chat_icon'] ?? 'fas fa-comments') == 'fas fa-comments' ? 'selected' : ''); ?>>💬 Comentários</option>
                                            <option value="fas fa-headset" <?php echo e(($landingSettings['chat_icon'] ?? 'fas fa-comments') == 'fas fa-headset' ? 'selected' : ''); ?>>🎧 Headset</option>
                                            <option value="fas fa-question-circle" <?php echo e(($landingSettings['chat_icon'] ?? 'fas fa-comments') == 'fas fa-question-circle' ? 'selected' : ''); ?>>❓ Interrogação</option>
                                            <option value="fas fa-robot" <?php echo e(($landingSettings['chat_icon'] ?? 'fas fa-comments') == 'fas fa-robot' ? 'selected' : ''); ?>>🤖 Robô</option>
                                        </select>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control <?php $__errorArgs = ['ai_settings.api_key'];
...
unset($__errorArgs, $__bag); ?>" 
                                   id="ai_api_key" name="ai_settings[api_key]" value="<?php echo e(old('ai_settings.api_key', $aiSettings['api_key'] ?? '')); ?>">
                            ...
                            <?php $__errorArgs = ['ai_settings.api_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select <?php $__errorArgs = ['ai_settings.model'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="ai_model" name="ai_settings[model]">
                                <optgroup label="Modelos Mini (Mais Rápidos e Econômicos)">
                                    <option value="gpt-4o-mini" <?php echo e(($aiSettings['model'] ?? 'gpt-4o-mini') == 'gpt-4o-mini' ? 'selected' : ''); ?>>GPT-4o Mini (Recomendado)</option>
                                    <option value="o1-mini" <?php echo e(($aiSettings['model'] ?? 'gpt-4o-mini') == 'o1-mini' ? 'selected' : ''); ?>>o1 Mini</option>
                                    <option value="o3-mini" <?php echo e(($aiSettings['model'] ?? 'gpt-4o-mini') == 'o3-mini' ? 'selected' : ''); ?>>o3 Mini</option>
                                    <option value="gpt-3.5-turbo" <?php echo e(($aiSettings['model'] ?? 'gpt-4o-mini') == 'gpt-3.5-turbo' ? 'selected' : ''); ?>>GPT-3.5 Turbo</option>
                                </optgroup>
                                <optgroup label="Modelos Padrão">
                                    <option value="gpt-4o" <?php echo e(($aiSettings['model'] ?? 'gpt-4o-mini') == 'gpt-4o' ? 'selected' : ''); ?>>GPT-4o</option>
                                    <option value="gpt-4-turbo" <?php echo e(($aiSettings['model'] ?? 'gpt-4o-mini') == 'gpt-4-turbo' ? 'selected' : ''); ?>>GPT-4 Turbo</option>
                                    <option value="gpt-4" <?php echo e(($aiSettings['model'] ?? 'gpt-4o-mini') == 'gpt-4' ? 'selected' : ''); ?>>GPT-4</option>
                                </optgroup>
                                <optgroup label="Modelos de Raciocínio">
                                    <option value="o1-preview" <?php echo e(($aiSettings['model'] ?? 'gpt-4o-mini') == 'o1-preview' ? 'selected' : ''); ?>>o1 Preview</option>
                                    <option value="o1" <?php echo e(($aiSettings['model'] ?? 'gpt-4o-mini') == 'o1' ? 'selected' : ''); ?>>o1</option>
                                    <option value="o3" <?php echo e(($aiSettings['model'] ?? 'gpt-4o-mini') == 'o3' ? 'selected' : ''); ?>>o3</option>
                                </optgroup>
                            </select>
                            <div class="form-text">Escolha o modelo do ChatGPT a ser utilizado. Modelos mini são mais rápidos e econômicos.</div>
                            <?php $__errorArgs = ['ai_settings.model'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?php $__errorArgs = ['ai_settings.system_prompt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      id="ai_system_prompt" name="ai_settings[system_prompt]" rows="4"><?php echo e(old('ai_settings.system_prompt', $aiSettings['system_prompt'] ?? '')); ?></textarea>
                            <div class="form-text">Defina a personalidade ou comportamento do assistente ao criar templates.</div>
                            <?php $__errorArgs = ['ai_settings.system_prompt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?php $__errorArgs = ['ai_settings.email_template_prompt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      id="ai_email_template_prompt" name="ai_settings[email_template_prompt]" rows="8"><?php echo e(old('ai_settings.email_template_prompt', $aiSettings['email_template_prompt'] ?? '')); ?></textarea>
                            ...
                            <?php $__errorArgs = ['ai_settings.email_template_prompt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?php $__errorArgs = ['ai_settings.whatsapp_template_prompt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      id="ai_whatsapp_template_prompt" name="ai_settings[whatsapp_template_prompt]" rows="6"><?php echo e(old('ai_settings.whatsapp_template_prompt', $aiSettings['whatsapp_template_prompt'] ?? '')); ?></textarea>
                            ...
                            <?php $__errorArgs = ['ai_settings.whatsapp_template_prompt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?php $__errorArgs = ['ai_settings.contract_template_prompt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      id="ai_contract_template_prompt" name="ai_settings[contract_template_prompt]" rows="10"><?php echo e(old('ai_settings.contract_template_prompt', $aiSettings['contract_template_prompt'] ?? '')); ?></textarea>
                            ...
                            <?php $__errorArgs = ['ai_settings.contract_template_prompt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?php $__errorArgs = ['ai_settings.support_prompt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      id="ai_support_prompt" name="ai_settings[support_prompt]" rows="8"><?php echo e(old('ai_settings.support_prompt', $aiSettings['support_prompt'] ?? '')); ?></textarea>
                            ...
                            <?php $__errorArgs = ['ai_settings.support_prompt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="ai_is_active" name="ai_settings[is_active]" 
                                       value="1" <?php echo e(($aiSettings['is_active'] ?? false) ? 'checked' : ''); ?>>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable_school_signature" name="contract_settings[enable_school_signature]" 
                                               value="1" <?php echo e(($contractSettings['enable_school_signature'] ?? false) ? 'checked' : ''); ?>>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="school_signature_name" name="contract_settings[school_signature_name]" 
                                                   value="<?php echo e(old('contract_settings.school_signature_name', $contractSettings['school_signature_name'] ?? '')); ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="school_signature_title" name="contract_settings[school_signature_title]" 
                                                   value="<?php echo e(old('contract_settings.school_signature_title', $contractSettings['school_signature_title'] ?? '')); ?>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" id="school_signature_data" name="contract_settings[school_signature_data]" 
                                           value="<?php echo e(old('contract_settings.school_signature_data', $contractSettings['school_signature_data'] ?? '')); ?>">
                                </div>
                                
                                <!-- Preview da assinatura atual -->
                                <?php if(!empty($contractSettings['school_signature_data'])): ?>
                                <div class="mb-3">
                                    ...
                                    <div class="current-signature-preview" style="border: 1px solid #ddd; border-radius: 8px; padding: 1rem; background: #f8f9fa; text-align: center;">
                                        <img src="<?php echo e($contractSettings['school_signature_data']); ?>" alt="Assinatura da Escola" style="max-width: 300px; max-height: 100px;">
                                        <div class="mt-2">
                                            <strong><?php echo e($contractSettings['school_signature_name'] ?? 'Nome não definido'); ?></strong><br>
                                            <small class="text-muted"><?php echo e($contractSettings['school_signature_title'] ?? 'Cargo não definido'); ?></small>
                                        </div>
                                    </div>
                                </div>
                                <?php endif; ?>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="contract_validity_days" name="contract_settings[validity_days]" 
                                                   value="<?php echo e(old('contract_settings.validity_days', $contractSettings['validity_days'] ?? 30)); ?>"
                                                   min="1" max="365">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="contract_reminder_days" name="contract_settings[reminder_days]" 
                                                   value="<?php echo e(old('contract_settings.reminder_days', $contractSettings['reminder_days'] ?? 3)); ?>"
                                                   min="1" max="30">
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="contract_auto_send" name="contract_settings[auto_send]" 
                                           value="1" <?php echo e(($contractSettings['auto_send'] ?? false) ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="contract_auto_reminder" name="contract_settings[auto_reminder]" 
                                           value="1" <?php echo e(($contractSettings['auto_reminder'] ?? false) ? 'checked' : ''); ?>>
                ...
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="mercadopago_enabled" name="payment_settings[mercadopago_enabled]" 
                                               value="1" <?php echo e(($paymentSettings['mercadopago_enabled'] ?? false) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="mercadopago_sandbox" name="payment_settings[mercadopago_sandbox]" 
                                                   value="1" <?php echo e(($paymentSettings['mercadopago_sandbox'] ?? false) ? 'checked' : ''); ?>>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" id="mercadopago_access_token" name="payment_settings[mercadopago_access_token]" 
                                                   value="<?php echo e(old('payment_settings.mercadopago_access_token', $paymentSettings['mercadopago_access_token'] ?? '')); ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="mercadopago_public_key" name="payment_settings[mercadopago_public_key]" 
                                                   value="<?php echo e(old('payment_settings.mercadopago_public_key', $paymentSettings['mercadopago_public_key'] ?? '')); ?>"
                                                   placeholder="APP_USR-xxxxx-xxxxxx-xxxxx">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" id="mercadopago_sandbox_access_token" name="payment_settings[mercadopago_sandbox_access_token]" 
                                                   value="<?php echo e(old('payment_settings.mercadopago_sandbox_access_token', $paymentSettings['mercadopago_sandbox_access_token'] ?? '')); ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="mercadopago_sandbox_public_key" name="payment_settings[mercadopago_sandbox_public_key]" 
                                                   value="<?php echo e(old('payment_settings.mercadopago_sandbox_public_key', $paymentSettings['mercadopago_sandbox_public_key'] ?? '')); ?>"
                                                   placeholder="TEST-xxxxx-xxxxxx-xxxxx">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="mercadopago_webhook_secret" name="payment_settings[mercadopago_webhook_secret]" 
                                           value="<?php echo e(old('payment_settings.mercadopago_webhook_secret', $paymentSettings['mercadopago_webhook_secret'] ?? '')); ?>"
                                ...
                                <div class="alert alert-warning">
                                    <i class="fas fa-exclamation-triangle me-2"></i>
                                    <strong>URL do Webhook:</strong> <code><?php echo e(url('/webhook/mercadopago')); ?></code><br>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="mercadopago_email_notifications" name="payment_settings[mercadopago_email_notifications]" 
                                                   value="1" <?php echo e(($paymentSettings['mercadopago_email_notifications'] ?? true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="mercadopago_whatsapp_notifications" name="payment_settings[mercadopago_whatsapp_notifications]" 
                                                   value="1" <?php echo e(($paymentSettings['mercadopago_whatsapp_notifications'] ?? false) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="mercadopago_sms_notifications" name="payment_settings[mercadopago_sms_notifications]" 
                                                   value="1" <?php echo e(($paymentSettings['mercadopago_sms_notifications'] ?? false) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="mercadopago_auto_reminders" name="payment_settings[mercadopago_auto_reminders]" 
                                                   value="1" <?php echo e(($paymentSettings['mercadopago_auto_reminders'] ?? true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="mercadopago_auto_generation" name="payment_settings[mercadopago_auto_generation]" 
                                                   value="1" <?php echo e(($paymentSettings['mercadopago_auto_generation'] ?? true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="mercadopago_currency" name="payment_settings[mercadopago_currency]">
                                                <option value="BRL" <?php echo e(($paymentSettings['mercadopago_currency'] ?? 'BRL') === 'BRL' ? 'selected' : ''); ?>>Real Brasileiro (BRL)</option>
                                                <option value="USD" <?php echo e(($paymentSettings['mercadopago_currency'] ?? 'BRL') === 'USD' ? 'selected' : ''); ?>>Dólar Americano (USD)</option>
                                                <option value="EUR" <?php echo e(($paymentSettings['mercadopago_currency'] ?? 'BRL') === 'EUR' ? 'selected' : ''); ?>>Euro (EUR)</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="mercadopago_country" name="payment_settings[mercadopago_country]">
                                                <option value="BR" <?php echo e(($paymentSettings['mercadopago_country'] ?? 'BR') === 'BR' ? 'selected' : ''); ?>>Brasil</option>
                                                <option value="AR" <?php echo e(($paymentSettings['mercadopago_country'] ?? 'BR') === 'AR' ? 'selected' : ''); ?>>Argentina</option>
                                                <option value="MX" <?php echo e(($paymentSettings['mercadopago_country'] ?? 'BR') === 'MX' ? 'selected' : ''); ?>>México</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="<?php echo e(route('admin.payments.dashboard')); ?>" class="btn btn-outline-secondary me-2">
                                    <i class="fas fa-chart-line me-2"></i>
                                    Dashboard de Pagamentos
                                </a>
                                <a href="<?php echo e(route('admin.payments.index')); ?>" class="btn btn-outline-info">
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Douglas\Documents\Projetos\ensinocerto\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>