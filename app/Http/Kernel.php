...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\SetUserSession::class,
    ...
    protected $middlewareAliases = [
        ...
        'all_staff' => \App\Http\Middleware\AllStaffMiddleware::class,
        'parceiro' => \App\Http\Middleware\ParceiroMiddleware::class,
        'check_permission' => \App\Http\Middleware\CheckPermission::class,
        'module' => \App\Http\Middleware\CheckModuleAccess::class,
        'impersonation_security' => \App\Http\Middleware\ImpersonationSecurityMiddleware::class,
